package com.codeterps.streetfighterframedojo.util;
...
public class MediaUtils {
    ...
    public static String getCharPortraitUri(String gameName, String charName) {
        return "char_portraits/" + gameName + "/" + charName + ".png";
    }
